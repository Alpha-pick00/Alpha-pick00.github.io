...
export const ProjectDetail = () => {
  ...
  if (!project) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center text-neutral-950">
        <div className="text-center">
          <h1 className="text-4xl mb-4">Project not found</h1>
          <Link to="/work" className="text-neutral-500 hover:text-neutral-950 underline">Back to Archive</Link>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-white min-h-screen text-neutral-950 pt-32 px-6">
      <div className="container mx-auto">
        <Link to="/work" className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-widest text-neutral-500 hover:text-neutral-950 transition-colors mb-12">
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-end gap-8 mb-16">
             ...
             <span className="font-mono text-sm text-neutral-600 mb-2">{project.category}</span>
          </div>

          <div className="aspect-[16/9] w-full bg-neutral-100 overflow-hidden rounded-sm">
             <motion.img 
               initial={{ scale: 1.1 }}
               animate={{ scale: 1 }}
        ...
        <div className="grid md:grid-cols-[1fr_2fr] gap-24 mb-32">
           <div className="space-y-12">
              <div>
                <span className="text-xs font-mono uppercase tracking-widest text-neutral-400 block mb-2">Client</span>
                <p className="text-xl font-light">{project.client}</p>
              </div>
              <div>
                <span className="text-xs font-mono uppercase tracking-widest text-neutral-400 block mb-2">Role</span>
           ...
           <div>
              ...
              <div className="mt-16 pt-16 border-t border-black/10">
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="bg-neutral-100 aspect-square rounded-sm overflow-hidden">
