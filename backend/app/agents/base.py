...
CLARIFY_INSTRUCTIONS = (
    ...
    "products는 브랜드가 아니라 그 브랜드 안에서 서로 다른 제품 라인/모델명입니다 "
    "(예: 브랜드 '빙그레' 안에 '메로나', '비비빅', '투게더'처럼 서로 다른 제품이 "
    "섞여 있는 경우). 한 브랜드에 제품이 하나뿐이면 products는 빈 배열로 두세요 — "
    "브랜드명과 똑같은 값을 억지로 넣지 마세요. "
